...
<Navbarr>
    ...
    <table class="table table-lg w-full lg:mx-6 px-0">
        <thead>
            <tr>
                <th class="text-base ml-3 pl-3 mr-1 pr-1">Bebé</th>
                <!--<th class="text-base mx-1 px-1">Prioridad</th>-->
                <!--<th class="text-base mx-1 px-1">Acciones</th>-->
                <th class="text-base mx-1 px-1">Último abrazo</th>            
            </tr>
        </thead>
        <tbody>
            {#each bebesrows as b}
                    ...
                    <td class="text-base ml-3 pl-3 mr-1 pr-1">
                        ...
                        {#if b.prioridad > 1}
                            <div class="tooltip" data-tip="Alta prioridad">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="red" class="size-3">
